...
down_revision: str | Sequence[str] | None = "a8c0d2e4f6b7"
        ...
        if not _index_exists("field_actuals_line_items", "ix_field_actuals_line_items_project_id"):
            with op.batch_alter_table("field_actuals_line_items", schema=None) as batch_op:
                batch_op.create_index(
                    batch_op.f("ix_field_actuals_line_items_project_id"), ["project_id"], unique=False
                )
